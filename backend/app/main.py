...
DEMO_REPORT_TITLES = [
    ...
    "Floodwater blocking main entrance",
    "Evacuation assistance needed near library",
    "First aid triage active at gym",
    "Backup power needed at student center",
    "Standing water hazard near parking lot 4",
    "Temporary shelter nearing capacity",
    "Potable water shortage at dining hall",
    "Meal support needed for displaced families",
    "Medication refrigeration risk at health center",
    "Responder route update at police station",
    "Downed power line near west parking loop",
    "Debris blocking ambulance access to health center",
]
